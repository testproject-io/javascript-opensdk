...
describe('SDK will attempt to infer Project and Job names', () => {
  let driver: ThenableBaseDriver;
  let login: LoginPage;
  let profilePage: ProfilePage;

  beforeEach(() => {
    driver = new Builder().forBrowser('chrome').withToken(ConfigHelper.developerToken()).build();
  });
  ...
  it('Test name will be that text', async () => {
